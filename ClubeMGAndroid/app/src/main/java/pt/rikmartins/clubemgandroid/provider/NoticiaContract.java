...
public class NoticiaContract {
    ...
    private static final String PATH_NOTICIA      = Noticia.TABLE_NAME_SINGULAR;
    private static final String PATH_CATEGORIA    = Categoria.TABLE_NAME_SINGULAR;
    private static final String PATH_ETIQUETA     = Etiqueta.TABLE_NAME_SINGULAR;
